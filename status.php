...
$audio_id = ''; //Your audio id 2 (Example '456241321')
...
$edit = curl('https://api.vk.com/method/audio.edit?access_token='.$access_token.'&owner_id='.$owner_id.'&audio_id='.$audio_id.'&artist='.$artist.'&title='.urlencode($title).'&genre_id=18&no_search=0&v=5.122');
